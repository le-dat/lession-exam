...
export default function AdminLessons() {
  ...
  const lessons = [
    ...
    { 
      ...
      duration: '50 mins', 
      students: 128,
      content: '# React Hooks\n\nMaster the use of React Hooks in your applications.',
      status: 'draft'
    },
  ];
          ...
          >
            <div className="p-6">
              ...
              <div className="space-y-2 mb-4">
                <div className="text-sm text-gray-500">Duration: {lesson.duration}</div>
                <div className="text-sm text-gray-500">Students: {lesson.students}</div>
              </div>
